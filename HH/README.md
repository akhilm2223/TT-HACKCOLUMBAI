...
[![IFM K2-Think](https://img.shields.io/badge/IFM-K2_Think-FF6B35.svg)](https://huggingface.co/LLM360/K2-Think)
...
│                   │                   │                   │                 │
│ • EMBED_TEXT_768  │ • 5 Local Tools   │ • Hybrid Vision   │ • Subscription  │
│ • COMPLETE (LLM)  │ • Agent SDK       │ • Spatial Logic   │   Management    │
...
│              (Powered by IFM K2-Think LLM360)                    │
└──────────────────────────────────────────────────────────────────┘
                              │
                              ▼
              ┌───────────────────────────────┐
              │   1. Local CV Extraction      │
              │   • Find Blue/Green Blobs     │
              │   • Detect 50+ Line Segments  │
              └───────────────────────────────┘
                              │
                              ▼
              ┌───────────────────────────────┐
              │   2. Textual Description      │
              │   "Blue blob at [200,300]..." │
              │   "Line A: Horizontal, len 50"│
              │   "Line B: Vertical, len 30"  │
              └───────────────────────────────┘
                              │
                              ▼
              ┌───────────────────────────────┐
              │      3. K2-THINK REASONING    │
              │   "Given the geometry, Line A │
              │    must be the far edge..."   │
              └───────────────────────────────┘
                              │
                              ▼
              ┌───────────────────────────────┐
...
**Why K2-Think?**
Even though K2-Think is a text-based reasoning model, we unlock its potential for vision tasks by converting the image into a **geometric text problem**. This demonstrates the model's superior spatial reasoning capabilities compared to standard LLMs.
